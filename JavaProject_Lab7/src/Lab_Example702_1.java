...
public class Lab_Example702_1 {
	...
	static int[] validValues = { 101, 108, 201, 213, 266, 
			304, 311, 409, 411, 412 };
	static double[] price = { 0.89, 1.23, 3.50, 0.69, 
			5.79, 3.19, 0.99, 0.89, 1.26, 8.00 };
	...
	public static void inputItem() {
		...
		if(cheakItem(itemOrder)) {
			System.out.print("Item "+itemOrder+" is "+itemPrice);
		}
		else {
			System.out.print("Invalid Imet");
		}
	}
